...
- **v0.1.7 (code8) - fix definitivo**: canal de avisos con **id versionado** `disponibilidad_plazas_v2` en `NotificationChannels.kt` y `AlertPayload.kt` (la app mapea al canal; `NotificationDisplayer.kt:115-120`), migracion que borra el canal antiguo, y backend `CHANNEL_ALERT = "disponibilidad_plazas_v2"` (`fcm.py`) + docs (`notificaciones-fcm.md`, `architecture.md`) + tests Android. Version 0.1.7/code8.
