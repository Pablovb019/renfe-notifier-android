...
- **En curso**: `v0.2.3` (código 15) — fix de layout del detalle + icono launcher adaptativo (tren centrado, sin recorte por la máscara circular) + icono de notificación propio (`ic_stat_train`, ya no la "I" genérica). Pendiente de build firmado y validación en el realme.
