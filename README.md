...
- **En curso**: `v0.2.1` (código 13) — fix de layout del detalle (solape de botones sobre el contenido en el realme) + icono launcher adaptativo. Pendiente de build firmado y validación en el realme.
